...
<div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        ...
        <div class="flex items-center mt-1 space-x-3">
          ...
          <a  href="https://www.instagram.com/sorteososorio/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
          ...
          <a   href="https://www.facebook.com/profile.php?id=61550698383941" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
        ...
        <p class="mt-4 text-sm text-gray-500">
          Siguenos para no perderte de nuestros eventos y regalos a nuestros seguidores
        </p>
      </div>
    </div>
    <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
      ...
      <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
        ...
        <li>
          <a href="/terms" class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Terminos &amp; condiciones</a>
        </li>
      </ul>
    </div>
  </div>
