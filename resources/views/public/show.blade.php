...
@if($sorteo)
    ...
    <div class="grid grid-cols-12">
        <div class="col-span-4 col-start-5">
            <select onchange="random(this)" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <section id="sectionmodal" class="flex items-center justify-center bg-white">
                                ...
                                <div class="px-4 py-8 sm:px-10">
                                    ...
                                    <div class="mt-6">
                                        <div class="w-full space-y-6">
                                            ...
                                            <p class="my-3 text-green-600 font-bold">Total $ <span id="nt-total"></span>  MXN</p>
    ...
    <div class="fixed inset-x-0 bottom-0">
        ...
        <p    class="text-center mt-4 bg-white rounded-lg py-2">
            <span id="open" class="text-red-juan" >
                Continuar
            </span>
        </p>
    </div>
...
@else
<h2 class="text-center text-3xl py-20">No hay sorteos por el momento, <br>quedate al pendiente en nuestras redes sociales.</h2>
@endif
...
function initTickets(){
    ...
    console.log(Totalnumbers,arrayApiSelected);
